...
INSERT INTO `tbl_loans` VALUES (22,35,31,'2023-05-12 12:36:18','accept',20000,2000,1667,400,'payed'),(23,37,32,'2023-05-12 18:19:38','pending',20000,333,400,NULL,'paying'),(24,38,34,'2023-05-16 12:22:24','pending',15000,3000,300,NULL,'paying');
...
INSERT INTO `tbl_members` VALUES (0000000035,'vladiere','erhja','kazhu','male','+639863216322','1212-12-12','wosepo5888@asuflex.com','single','under heavens','$2b$10$Rte7U8NUehugXr.uiak6h.vrlPjXJ4ypskC3F6jaVLRNM0mq43ws.','2023-05-10 11:41:50','69 pc','atlantic ocean','active',0,'2023-05-14 03:19:20'),(0000000036,'lance phillip','berdon','descartin','male','09886985695','1500-12-31','lekomos529@dekaps.com','married','atlantic ocean','$2b$10$OXEPn19F0pI1u7WFdXEcbOEMcU0AJPWfk9EXiE1LWVGfNsEJWO2lq','2023-05-12 04:20:09','bipor','atlantic','active',19,'2023-05-14 09:18:35'),(0000000037,'robert','abut','quijano','male','+639874563215','1200-05-18','quijano@gmail.com','single','babag 2','$2b$10$KkC2Z2t7q4fk8tOrXC0MP.pD9OTyJ8IOruQMpCR/5e8RzYiRd5pH6','2023-05-12 10:14:52','12pc','under the sun','active',0,'2023-05-14 03:09:14'),(0000000038,'mercy','adsbu','macan','female','+639874563254','1222-12-12','yesedom590@appxapi.com','single','cordova','$2b$10$AsvpnobhALQr.wbfTNkOUOpHO9Hrl0ax0rH.zuKdBildiucbOayS.','2023-05-13 01:07:51','23px','under sun','active',0,'2023-05-17 21:46:46'),(0000000039,'mashle','shrom','burnhead','male','09874664123','1524-12-12','burnhead@magcad.com','single','magcad city','$2b$10$9OeqmHOKBHl54HEqiunB1usJZTY5H8rSXBz0G2MoWN.qvRGjTyHHi','2023-05-15 19:14:51','magcad','n/a','active',0,'2023-05-16 04:33:06'),(0000000040,'dianne','berdon','descartin','female','+639874645899','1111-11-11','dianne@email.com','single','babag 2','$2b$10$JKs/4g6JKCr3DBDJ3k1G1.IPVf9RIGkcYC7oYWhvVKBXwcerA8Krq','2023-05-15 20:44:41','12px','suns microsoft','active',14,'2023-05-16 04:44:41'),(0000000041,'botchoy','shdn','abot','male','09856565632','1998-05-22','botchoy@email.com','Separate','cebu','$2b$10$46pGjcgm8e42tDkzGq1iy.YYyjifTq4iB6eF9VAgemXRXwLSlh352','2023-05-15 20:48:24','desrt','hidra','active',0,'2023-05-16 04:48:24'),(0000000042,'patty','reik','iring','female','09123456789','2023-04-12','patty@iring.com','single','babg 2','$2b$10$wvsILvcrdzkDTET2pfLIOOF.EXtgM38pMlaooify3cL/iQpjCGJBm','2023-05-15 20:52:56','whiskeys','n/a','active',0,'2023-05-16 04:54:16');
...
INSERT INTO `tbl_pettycash` VALUES (0000000015,35,5000,'2023-05-10 19:41:50'),(0000000017,36,2000,'2023-05-12 12:20:09'),(0000000019,37,2000,'2023-05-12 18:14:52'),(0000000020,38,2000,'2023-05-13 09:07:51'),(0000000021,39,2000,'2023-05-16 03:14:51'),(0000000022,40,1000,'2023-05-16 04:44:41'),(0000000023,41,1200,'2023-05-16 04:48:24'),(0000000024,42,2500,'2023-05-16 04:52:56');
...
INSERT INTO `tbl_savings` VALUES (18,35,400,'2023-05-12 12:45:54',0,0),(30,35,600,'2023-05-16 03:46:15',0,200),(31,35,700,'2023-05-16 03:46:42',0,100),(32,35,400,'2023-05-16 03:47:16',300,0),(33,35,550,'2023-05-16 03:48:24',0,150);
	...
	IF p_desc = 'update' THEN
		IF EXISTS(SELECT id FROM admin WHERE firstname = fname AND lastname = lname) THEN
			...
			IF fname <> '' AND lname <> '' AND email <> '' AND uname <> '' AND pass <> '' THEN
				UPDATE `admin` SET `email`=email,`username`=username,`password`=pass,`updated_at`=NOW() WHERE id = p_id;
				SET ret = 2;
				SET st_code = 200;
...
BEGIN
    ...
    SELECT counterlock INTO c_lock FROM `tbl_members` WHERE lastname = p_lastname LIMIT 1;
    SELECT `status` INTO m_status FROM `tbl_members` WHERE lastname = p_lastname LIMIT 1;
	...
	ELSEIF p_status = 1 THEN
        ...
        IF c_lock >= 3 THEN
			SET ret = 2, ret_msg = 'Account Locked';
        ELSE
...
BEGIN
	IF p_id <> 0 THEN
		SELECT tp.id,tp.balance,DATE_FORMAT(add_at,'%M %d, %Y') AS formatted_date,tm.firstname,tm.middlename,tm.lastname FROM tbl_pettycash AS tp LEFT JOIN tbl_members AS tm ON tp.member_id = tm.id WHERE tp.member_id = p_id;
    ELSE
		IF p_search <> '' THEN
        ...
        ELSE
			SELECT tp.id,tp.balance,tm.firstname,DATE_FORMAT(add_at,'%M %d, %Y') AS formatted_date,tm.middlename,tm.lastname FROM tbl_pettycash AS tp LEFT JOIN tbl_members AS tm ON tp.member_id = tm.id ORDER BY add_at DESC;
        END IF;
    END IF;
END ;;
DELIMITER ;
...
BEGIN
    ...
    IF p_id <> '' AND p_email = '' THEN
		IF p_token = '' THEN
			IF p_newpass <> '' THEN        
				UPDATE tbl_members SET password = p_newpass, updated_at = NOW() WHERE id = p_id;
				SET st_code = 200, st_msg = 'Password Updated Successfully';
			END IF;
		END IF;
    ELSE
		IF p_newpass <> '' THEN
...
BEGIN
	...
	IF p_desc = 'deposit' THEN
		INSERT INTO tbl_savings (`member_id`,`amount`,`deposit`) VALUES (p_id,s_amount + p_amount, p_amount);
        SET st_code = 200, st_msg = "Deposit Successfully";
        SELECT st_code, st_msg;
    END IF;
    IF p_desc = 'withdraw' THEN
		INSERT INTO tbl_savings (`member_id`,`amount`,`withdraw`) VALUES (p_id,s_amount - p_amount, p_amount);
...
-- Dump completed on 2023-05-18 16:10:11
